...
export const initialState = {
  intersperse: {
    ...
    phonetics: [
      {
        text: '/ˌɪn(t)ərˈspərs/',
        audio: 'https://lex-audio.useremarkable.com/mp3/intersperse_us_1.mp3',
      },
    ],
    meanings: [
      {
    ...
    translation: [
      {language: 'fa', translation: ['باب', 'کراس', '"', 'نیک', 'بت', 'احیا']},
    ],
  },
  dread: {
    word: 'dread',
    ...
    translation: [
      {
        language: 'fa',
        translation: ['ترس', 'هراس', 'وحشت', 'خوف', 'دهشت', 'ترسیده‌است'],
      },
    ],
  },
  vague: {
    ...
    translation: [
      {
        language: 'fa',
        translation: ['مبهم', 'ابهام', 'گنگ', 'نامعلوم', 'نامشخص', 'مبهم :'],
      },
    ],
  },
  sacred: {
    ...
    translation: [
      {
        language: 'fa',
        translation: ['مقدس', 'قدسی', 'قدس', 'تقدس', 'متبرک', 'روحانی'],
      },
    ],
  },
  whirlpool: {
  ...
  crowning: {
    ...
    translation: [
      {
        language: 'fa',
        translation: ['تاجگذاری', 'شکوه', 'صدر', 'بر', 'تمام', 'تاج گذاری'],
      },
    ],
  },
  seldom: {
  ...
  encompass: {
    ...
    phonetics: [
      {
        text: '/ɪnˈkəmpəs/',
        audio: 'https://lex-audio.useremarkable.com/mp3/encompass_us_1.mp3',
      },
      {
        text: '/ɛnˈkəmpəs/',
        audio: 'https://lex-audio.useremarkable.com/mp3/encompass_us_2.mp3',
      },
    ],
    meanings: [
      {
        ...
        definitions: [
          ...
          {
            definition: 'Cause (something) to take place.',
  ...
  preponderance: {
    ...
    translation: [
      {
        language: 'fa',
        translation: ['برتری', 'مزیت', 'مزایا', 'مزایای', 'کیس', 'رجحان'],
      },
    ],
  },
  commensurate: {
  ...
  daring: {
    ...
    translation: [
      {
        language: 'fa',
        translation: ['جسور', 'تهور', 'جسارت', 'جسورانه', 'جرات', 'بی‌باک'],
      },
    ],
  },
  realm: {
  ...
  divine: {
    ...
    translation: [
      {
        language: 'fa',
        translation: ['الهی', 'خدایی', 'ایزدی', 'یزدانی', 'خدا', 'الاهی'],
      },
    ],
  },
  inhibition: {
  ...
  catapult: {
    ...
    phonetics: [
      {
        text: '/ˈkædəˌpəlt/',
        audio: 'https://lex-audio.useremarkable.com/mp3/catapult_us_2.mp3',
      },
    ],
    meanings: [
      {
    ...
    translation: [
      {
        language: 'fa',
        translation: ['منجنیق', 'سوق', 'پرتاب', 'تیر', 'یانگ', 'جذب'],
      },
    ],
  },
  azure: {
  ...
  seizing: {
    ...
    translation: [
      {
        language: 'fa',
        translation: ['برداشت', 'ضبط', 'تصرف', 'توقیف', 'گرفت', 'قاپید'],
      },
    ],
  },
  peering: {
  ...
  pamper: {
    ...
    phonetics: [
      {
        text: '/ˈpæmpər/',
        audio: 'https://lex-audio.useremarkable.com/mp3/pamper_us_1.mp3',
      },
    ],
    meanings: [
      {
    ...
    translation: [
      {language: 'fa', translation: ['ناز', 'هاو', 'لوس', 'بوم', 'لاس', 'پا']},
    ],
  },
  merely: {
    word: 'merely',
    ...
    translation: [
      {
        language: 'fa',
        translation: ['فقط …', 'صرفا …', 'فقط', 'صرفا', 'تنها', 'فقط ,'],
      },
    ],
  },
  lethargy: {
    ...
    translation: [
      {
        language: 'fa',
        translation: ['بی‌حالی', 'رخوت', 'خواب', 'رخوت :', 'کسالت', 'سنگینی'],
      },
    ],
  },
  plague: {
  ...
  whisk: {
    ...
    phonetics: [
      {
        text: '/(h)wɪsk/',
        audio: 'https://lex-audio.useremarkable.com/mp3/whisk_us_1.mp3',
      },
    ],
    meanings: [
      {
        ...
        definitions: [
          {
            ...
            example: 'his jacket was whisked away for dry cleaning',
          ...
          {
            definition: 'Brush with a whisk broom.',
            example:
      ...
      },
      {
        ...
        definitions: [
          ...
          },
          {
            ...
            example: "a whisk around St. Basil's cathedral",
            synonyms: ['flick', 'twitch', 'wave', 'sweep', 'swipe'],
          },
          {definition: 'short for whisk broom'},
        ],
      },
    ],
    translation: [
  ...
  superficial: {
    ...
    translation: [
      {
        language: 'fa',
        translation: ['سطحی', 'سطحی :', 'ظاهری', 'کم‌عمق', 'صوری', 'سطح'],
      },
    ],
  },
  obliterate: {
  ...
  demise: {
    ...
    translation: [
      {
        language: 'fa',
        translation: ['مرگ', 'وفات', 'درگذشت', 'فوت', 'وفات :', 'سقوط'],
      },
    ],
  },
  reconcile: {
    ...
    phonetics: [
      {
        text: '/ˈrɛkənˌsaɪl/',
        audio: 'https://lex-audio.useremarkable.com/mp3/reconcile_us_1.mp3',
      },
    ],
    meanings: [
      {
  ...
  loathing: {
    ...
    translation: [
      {
        language: 'fa',
        translation: ['تنفر', 'انزجار', 'نفرت', 'تنفر :', 'کینه', 'تنفر .'],
      },
    ],
  },
  murky: {
    ...
    translation: [
      {
        language: 'fa',
        translation: ['تیره', 'تاریک', 'گیج', 'تاریکی', 'ابهام', 'تیره است'],
      },
    ],
  },
  fiasco: {
  ...
  frivolous: {
    ...
    translation: [
      {
        language: 'fa',
        translation: ['جلف', 'سبک', 'بی‌هوده', 'بی‌مصرف', 'سبک‌مغز', 'سبک سر'],
      },
    ],
  },
  impermanence: {
  ...
  forfeit: {
    ...
    phonetics: [
      {
        text: '/ˈfɔrfət/',
        audio: 'https://lex-audio.useremarkable.com/mp3/forfeit_us_1.mp3',
      },
    ],
    meanings: [
      {
    ...
    translation: [
      {
        language: 'fa',
        translation: ['جریمه', 'تاوان', 'خسارت', 'لغو', 'مجازات', 'کلی'],
      },
    ],
  },
  sulk: {
    ...
    phonetics: [
      {
        text: '/səlk/',
        audio: 'https://lex-audio.useremarkable.com/mp3/sulk_us_1.mp3',
      },
    ],
    meanings: [
      {
        partOfSpeech: 'verbo intransitivo',
        definitions: [
          {
            definition:
              'Be silent, morose, and bad-tempered out of annoyance or disappointment.',
            example: 'he was sulking over the breakup of his band',
            synonyms: [
              'mope',
              'brood',
              'pout',
    ...
    translation: [
      {
        language: 'fa',
        translation: ['قهر', 'اخم', 'غیض', 'اخم می‌کند', 'اخم‌هایش', 'ترشرویی'],
      },
    ],
  },
  meticulously: {
  ...
  affection: {
    ...
    translation: [
      {
        language: 'fa',
        translation: ['علاقه', 'عاطفه :', 'محبت', 'عاطفه', 'علاقه :', 'محبت :'],
      },
    ],
  },
  delineation: {
    ...
    translation: [
      {
        language: 'fa',
        translation: ['تشریح', 'ترسیم', 'تعریف', 'توصیف', 'طرح', 'توضیح'],
      },
    ],
  },
  tantrum: {
  ...
  coddle: {
    ...
    phonetics: [
      {
        text: '/ˈkɑdl/',
        audio: 'https://lex-audio.useremarkable.com/mp3/coddle_us_1.mp3',
      },
    ],
    meanings: [
      {
    ...
    translation: [
      {
        language: 'fa',
        translation: ['ناز', 'نوازش', 'مارکز', 'اذیت', 'کواکس', 'درجه‌بندی'],
      },
    ],
  },
  bluntness: {
  ...
  impediment: {
    ...
    translation: [
      {
        language: 'fa',
        translation: ['بازداری', 'مانع', 'موانع', 'لکنت', 'منع', 'مشکل'],
      },
    ],
  },
  rudder: {
    ...
    translation: [
      {
        language: 'fa',
        translation: ['سکان', 'باله', 'میله', 'میله سکان', 'گرداننده', 'بدنه'],
      },
    ],
  },
  frightening: {
  ...
  flounder: {
    ...
    phonetics: [
      {
        text: '/ˈflaʊndər/',
        audio: 'https://lex-audio.useremarkable.com/mp3/flounder_us_1.mp3',
      },
    ],
    meanings: [
      {
    ...
    translation: [
      {
        language: 'fa',
        translation: ['فلان', 'فلان …', 'گیر', 'در', 'کلنجار', 'دست'],
      },
    ],
  },
  replete: {
    ...
    translation: [
      {
        language: 'fa',
        translation: ['مفصلی', 'پر از', 'پر', 'انبوهی', 'انباشته', 'جین'],
      },
    ],
  },
  hopscotch: {
    ...
    phonetics: [
      {
        ...
        audio: 'https://lex-audio.useremarkable.com/mp3/procrastinate_us_3.mp3',
      },
    ],
    meanings: [
      {
        ...
        definitions: [
          {
            ...
            example: "it won't be this price for long, so don't procrastinate",
            synonyms: [
              'delay',
  ...
  propel: {
    ...
    translation: [
      {
        language: 'fa',
        translation: ['حرکت', 'سوق', 'هل دادن', 'جلو', 'رانده', 'به جلو'],
      },
    ],
  },
  perplexed: {
  ...
  beckon: {
    ...
    phonetics: [
      {
        text: '/ˈbɛkən/',
        audio: 'https://lex-audio.useremarkable.com/mp3/beckon_us_1.mp3',
      },
    ],
    meanings: [
      {
  ...
  esoteric: {
    ...
    translation: [
      {
        language: 'fa',
        translation: ['محرمانه', 'سری', 'مرموز', 'راز', 'اسرارآمیز', 'شر'],
      },
    ],
  },
  despite: {
  ...
  relish: {
    ...
    translation: [
      {
        language: 'fa',
        translation: ['لذت', 'لذت :', 'لذت ببرید', 'طعم', 'رغبت', 'لذت بردن'],
      },
    ],
  },
  daze: {
    ...
    translation: [
      {
        language: 'fa',
        translation: ['گیجی', 'گیج', 'سرگیجه', 'گیج گیجی', 'شوک', 'مبهوت'],
      },
    ],
  },
  prodigy: {
  ...
  opaque: {
    ...
    translation: [
      {
        language: 'fa',
        translation: ['مات', 'مبهم', 'کدر', 'مات و مات', 'تار', 'نامشخص'],
      },
    ],
  },
  requisite: {
    ...
    translation: [
      {
        language: 'fa',
        translation: ['لازمه', 'لازمه …', 'لازم', 'لازم است', 'شرط', 'ضروری'],
      },
    ],
  },
  petty: {
    ...
    translation: [
      {
        language: 'fa',
        translation: ['پتی', 'کوچک', 'ریز', 'کم', 'ناچیز', 'جزیی'],
      },
    ],
  },
  trivial: {
  ...
  prolific: {
    ...
    translation: [
      {
        language: 'fa',
        translation: ['پرکاری', 'پرکار', 'فعال', 'کار', 'پرکارترین', 'پربار'],
      },
    ],
  },
  stifle: {
    ...
    phonetics: [
      {
        text: '/ˈstaɪfəl/',
        audio: 'https://lex-audio.useremarkable.com/mp3/stifle_us_1.mp3',
      },
    ],
    meanings: [
      {
  ...
  confine: {
    ...
    translation: [
      {
        language: 'fa',
        translation: ['محدود', 'مقید', 'محدوده', 'اکتفا کنید', 'محصور', 'حصر'],
      },
    ],
  },
  gruesome: {
  ...
  instinctive: {
    ...
    translation: [
      {
        language: 'fa',
        translation: ['مهاجمی', 'غریزی', 'غریزه', 'غریزی :', 'طبیعی', 'و'],
      },
    ],
  },
  stellar: {
  ...
  fling: {
    ...
    phonetics: [
      {
        text: '/flɪŋ/',
        audio: 'https://lex-audio.useremarkable.com/mp3/fling_us_1.mp3',
      },
    ],
    meanings: [
      {
      ...
      },
      {
        ...
        definitions: [
          {
            definition: 'A short period of enjoyment or wild behavior.',
  ...
  jolt: {
    ...
    phonetics: [
      {
        text: '/dʒoʊlt/',
        audio: 'https://lex-audio.useremarkable.com/mp3/jolt_us_1.mp3',
      },
    ],
    meanings: [
      {
    ...
    translation: [
      {
        language: 'fa',
        translation: ['ضربه', 'تکان', 'ماشین', 'سرعت', 'میل', 'هول'],
      },
    ],
  },
  overbearing: {
  ...
  rigorously: {
    ...
    translation: [
      {
        language: 'fa',
        translation: ['جدی', 'شدید', 'دقیق', 'با دقت', 'سختی', 'سخت'],
      },
    ],
  },
  impulsive: {
  ...
  admonish: {
    ...
    phonetics: [
      {
        text: '/ədˈmɑnɪʃ/',
        audio: 'https://lex-audio.useremarkable.com/mp3/admonish_us_1.mp3',
      },
    ],
    meanings: [
      {
  ...
  rebuff: {
    ...
    phonetics: [
      {
        text: '/rəˈbəf/',
        audio: 'https://lex-audio.useremarkable.com/mp3/rebuff_us_1.mp3',
      },
    ],
    meanings: [
      {
        ...
        definitions: [
          {
            ...
            example: 'any attempt to win her friendship was met with rebuffs',
    ...
    translation: [
      {
        ...
        translation: [
          ...
          'به او جواب داد',
          'به او جواب دادم',
          'که او را به زحمت انداخته',
          'و او را به زحمت انداخت',
          'جواب داد',
          'خودداری کرد',
        ],
      },
    ...
    translation: [
      {
        ...
        translation: [
          ...
          'رها کردن .',
          'دست از دست دادن',
          'دست از دست دادن بردار',
          'دست از دست دادن بردارید',
          'دست از دست دادن ,',
          'دست از دست دادن بردارید ,',
          'رها کردن …',
          'دست از دست relinquish',
          'رها کردن',
          'از دست دادن',
          'رها کنید',
          'رها کردن از',
  ...
  righteousness: {
    ...
    translation: [
      {
        language: 'fa',
        translation: ['حق', 'درستکاری', 'نیکی', 'حقانیت', 'درستی', 'راست'],
      },
    ],
  },
  devour: {
  ...
  perpetuate: {
    ...
    translation: [
      {
        language: 'fa',
        translation: ['تداوم', 'دائمی', 'جاودانی', 'جاودانه', 'ثابت', 'دایمی'],
      },
    ],
  },
  indignation: {
  ...
  hindrance: {
    ...
    translation: [
      {
        language: 'fa',
        translation: ['مانع', 'ممانعت', 'مزاحم', 'سد', 'بازداری', 'موانع'],
      },
    ],
  },
  rational: {
    ...
    translation: [
      {
        language: 'fa',
        translation: ['عقلانی', 'منطقی', 'معقول', 'عقلی', 'عقلایی', 'عاقلانه'],
      },
    ],
  },
  hindsight: {
    ...
    translation: [
      {
        language: 'fa',
        translation: ['درک', 'شناختی', 'ادراکی', 'درک :', 'شناخت', 'ادراک'],
      },
    ],
  },
  vain: {
  ...
  brunt: {
    ...
    translation: [
      {
        language: 'fa',
        translation: ['لطمه', 'برانت', 'فشار', 'بیداد', 'آتش', 'بارها'],
      },
    ],
  },
  arduous: {
  ...
  accolade: {
    ...
    phonetics: [
      {
        text: '/ˈækəˌleɪd/',
        audio: 'https://lex-audio.useremarkable.com/mp3/accolade_us_1.mp3',
      },
    ],
    meanings: [
      {
    ...
    translation: [
      {
        language: 'fa',
        translation: ['موضوع', 'امتیاز', 'بحث', 'سختی', 'شرکت', 'تشویق'],
      },
    ],
  },
  ornament: {
    ...
    phonetics: [
      {
        text: '/ˈɔrnəmənt/',
        audio: 'https://lex-audio.useremarkable.com/mp3/ornament_us_1.mp3',
      },
    ],
    meanings: [
      {
    ...
    translation: [
      {
        language: 'fa',
        translation: ['تزیین', 'زینت', 'تزیینات', 'زینتی', 'زیور', 'تزئینات'],
      },
    ],
  },
  raucous: {
  ...
  lethargic: {
    ...
    translation: [
      {
        language: 'fa',
        translation: ['بی‌حالی', 'سست', 'خواب‌آلود', 'کسالت', 'سستی', 'بی‌حال'],
      },
    ],
  },
  vacuous: {
  ...
  espouse: {
    ...
    translation: [
      {
        language: 'fa',
        translation: [')', 'پشتیبانی', 'کردن', '.', 'ترک', 'حمایت'],
      },
    ],
  },
  clamour: {
  ...
  bland: {
    ...
    translation: [
      {
        language: 'fa',
        translation: ['بی‌مزه', 'کوک', 'مودب', 'آرام', 'لوس', 'ملایم'],
      },
    ],
  },
  proverbial: {
  ...
  dignity: {
    ...
    translation: [
      {
        language: 'fa',
        translation: ['شان', 'وقار', 'عزت', 'کرامت', 'منزلت', 'مقام'],
      },
    ],
  },
  exacerbate: {
  ...
  inundation: {
    ...
    translation: [
      {
        language: 'fa',
        translation: ['سیلی', 'سیل', 'سیل‌گیری', 'طغیان', 'سیلاب', 'آب‌گرفتگی'],
      },
    ],
  },
  pervasiveness: {
  ...
  gawk: {
    ...
    phonetics: [
      {
        text: '/ɡɔk/',
        audio: 'https://lex-audio.useremarkable.com/mp3/gawk_us_1.mp3',
      },
    ],
    meanings: [
      {
        ...
        definitions: [
          {
            ...
            example: 'they were gawking at some pinup',
            synonyms: [
              'gape',
              'goggle',
              'gaze',
  ...
  infraction: {
    ...
    translation: [
      {
        language: 'fa',
        translation: ['تخلف', 'تخلفات', 'متخلف', 'نقض', 'ناقض', 'خطا'],
      },
    ],
  },
  resilient: {
  ...
  blatant: {
    ...
    translation: [
      {
        language: 'fa',
        translation: ['آشکار', 'وقیحانه', 'جنجالی', 'خودنما', 'خشن', 'روشن'],
      },
    ],
  },
  alienate: {
    ...
    phonetics: [
      {
        text: '/ˈeɪljəˌneɪt/',
        audio: 'https://lex-audio.useremarkable.com/mp3/alienate_us_1.mp3',
      },
    ],
    meanings: [
      {
  ...
  albeit: {
    ...
    translation: [
      {
        language: 'fa',
        translation: ['اگرچه', 'گرچه', 'هرچند', 'البته', 'گرچه ,', 'هرچند که'],
      },
    ],
  },
  suffocate: {
    ...
    translation: [
      {
        language: 'fa',
        translation: ['خفگی', 'خفه کردن', 'خفه شدن', 'خفقان', 'خفه', 'خفه شود'],
      },
    ],
  },
  revolve: {
    ...
    translation: [
      {
        language: 'fa',
        translation: ['چرخش', 'سیر', 'می‌چرخد', 'دور', 'چرخیدن', 'چرخ'],
      },
    ],
  },
  unravel: {
    ...
    phonetics: [
      {
        text: '/ˌənˈrævəl/',
        audio: 'https://lex-audio.useremarkable.com/mp3/unravel_us_1.mp3',
      },
    ],
    meanings: [
      {
  ...
  resentment: {
    ...
    translation: [
      {
        language: 'fa',
        translation: ['رنجش', 'دلخوری', 'خشم', 'تنفر', 'ناراحتی', 'نارضایتی'],
      },
    ],
  },
  rebellious: {
  ...
  claw: {
    ...
    phonetics: [
      {
        text: '/klɔ/',
        audio: 'https://lex-audio.useremarkable.com/mp3/claw_us_1.mp3',
      },
    ],
    meanings: [
      {
  ...
  rummage: {
    ...
    phonetics: [
      {
        text: '/ˈrəmɪdʒ/',
        audio: 'https://lex-audio.useremarkable.com/mp3/rummage_us_1.mp3',
      },
    ],
    meanings: [
      {
    ...
    translation: [
      {
        language: 'fa',
        translation: ['جستجو', 'بازرسی', 'کاوش', 'تحقیق', 'مطالعه', 'بررسی'],
      },
    ],
  },
  facade: {
  ...
  construe: {
    ...
    phonetics: [
      {
        text: '/kənˈstru/',
        audio: 'https://lex-audio.useremarkable.com/mp3/xconstrue_us_1.mp3',
      },
    ],
    meanings: [
      {
    ...
    translation: [
      {
        language: 'fa',
        translation: ['پنداشت', 'تفسیر', 'تعبیر', 'قیاس', 'توضیح', 'برداشت'],
      },
    ],
  },
  contagious: {
  ...
  alluring: {
    ...
    translation: [
      {
        language: 'fa',
        translation: ['فریبنده', 'افسونگر', 'جذاب', 'دل فریب', 'دلکش', 'دلربا'],
      },
    ],
  },
  exude: {
  ...
  fixate: {
    ...
    phonetics: [
      {
        text: '/ˈfɪkˌseɪt/',
        audio: 'https://lex-audio.useremarkable.com/mp3/fixate_us_2.mp3',
      },
    ],
    meanings: [
      {
        ...
        definitions: [
          ...
          {
            definition: "Direct one's eyes toward.",
  ...
  finagle: {
    ...
    phonetics: [
      {
        text: '/fəˈneɪɡ(ə)l/',
        audio: 'https://lex-audio.useremarkable.com/mp3/finagle_us_1.mp3',
      },
    ],
    meanings: [
      {
  ...
  virtue: {
    ...
    translation: [
      {
        language: 'fa',
        translation: ['فضیلت', 'تقوی', 'تقوا', 'پاکدامنی', 'فضیلت :', 'تقوای'],
      },
    ],
  },
  admonishment: {
  ...
  narrative: {
    ...
    translation: [
      {
        language: 'fa',
        translation: ['داستان', 'روایت', 'روایی', 'نقل', 'روایتی', 'متن'],
      },
    ],
  },
  summit: {
    ...
    translation: [
      {
        language: 'fa',
        translation: ['نشست', 'اجلاس', 'سامیت', 'قله', 'همایش', 'راس'],
      },
    ],
  },
  fruition: {
  ...
  compulsive: {
    ...
    translation: [
      {
        language: 'fa',
        translation: ['وسواسی', 'اجبار', 'وسواس', 'عملی', 'اجباری', 'جبری'],
      },
    ],
  },
  arbitrary: {
  ...
  alleviate: {
    ...
    translation: [
      {
        language: 'fa',
        translation: ['کاهش', 'کم کردن', 'کم کنید', 'تسکین', 'آرام', 'رفع'],
      },
    ],
  },
  attain: {
    ...
    phonetics: [
      {
        text: '/əˈteɪn/',
        audio: 'https://lex-audio.useremarkable.com/mp3/attain_us_1.mp3',
      },
    ],
    meanings: [
      {
  ...
  vogue: {
    ...
    translation: [
      {language: 'fa', translation: ['مد', 'مدی', 'رواج', 'متداول', 'رایج']},
    ],
  },
  perpetually: {
    word: 'perpetually',
  ...
  saunter: {
    ...
    phonetics: [
      {
        text: '/ˈsɔn(t)ər/',
        audio: 'https://lex-audio.useremarkable.com/mp3/saunter_us_1.mp3',
      },
    ],
    meanings: [
      {
    ...
    translation: [
      {
        language: 'fa',
        translation: ['پرسه', 'ولگردی', 'گشتی', 'بی‌هدف', 'سلانه', 'تردد'],
      },
    ],
  },
  compassion: {
    ...
    translation: [
      {
        language: 'fa',
        translation: ['شفقت', 'رحم', 'دلسوزی', 'همدردی', 'رحم و شفقت', 'ترحم'],
      },
    ],
  },
  youth: {
  ...
  chafe: {
    ...
    phonetics: [
      {
        text: '/tʃeɪf/',
        audio: 'https://lex-audio.useremarkable.com/mp3/chafe_us_1.mp3',
      },
    ],
    meanings: [
      {
        ...
        definitions: [
          ...
          },
          {
            ...
            example: 'I chafed her feet and wrapped the blanket around her',
    ...
    translation: [
      {
        language: 'fa',
        translation: ['ترش', 'تور', 'سوخته', 'عصبانی', 'اشتباه', 'ردیف'],
      },
    ],
  },
  weary: {
  ...
  macho: {
    ...
    translation: [
      {language: 'fa', translation: ['مردانه', '-', '- -', 'کام', 'و', 'سینا']},
    ],
  },
  matriarch: {
    word: 'matriarch',
  ...
  archaic: {
    ...
    translation: [
      {
        language: 'fa',
        translation: ['باستانی', 'قدیمی', 'منسوخ', 'باستان', 'کهنه', 'قدیم'],
      },
    ],
  },
  inkling: {
  ...
  fathom: {
    ...
    translation: [
      {
        language: 'fa',
        translation: ['درک', 'شناخت', 'فهم', 'عمق', 'درک کنید', 'چکیده'],
      },
    ],
  },
  offspring: {
    ...
    translation: [
      {
        language: 'fa',
        translation: ['نتاج', 'فرزند', 'فرزندان', 'بچه', 'اولاد', 'زاد و ولد'],
      },
    ],
  },
  fertile: {
  ...
  sterile: {
    ...
    translation: [
      {
        language: 'fa',
        translation: ['استریل', 'عقیم', 'سترون', 'نازا', 'استریل :', 'عقیم :'],
      },
    ],
  },
  genus: {
    ...
    phonetics: [
      {
        text: '/ˈdʒinəs/',
        audio: 'https://lex-audio.useremarkable.com/mp3/genus_us_1.mp3',
      },
    ],
    meanings: [
      {
  ...
  patriarch: {
    ...
    translation: [
      {
        language: 'fa',
        translation: ['پاتریارک', 'شیخ', 'اسقف', 'بطرک', 'پدر', 'بیشاپ'],
      },
    ],
  },
  lineage: {
    ...
    translation: [
      {
        language: 'fa',
        translation: ['نسب', 'دودمان', 'اصل', 'رده', 'نسب :', 'تبار'],
      },
    ],
  },
  ferocious: {
  ...
  cognitive: {
    ...
    translation: [
      {
        language: 'fa',
        translation: ['شناختی', 'ادراکی', 'شناختی :', 'شناخت', 'ادراکی :'],
      },
    ],
  },
  fictive: {
  ...
  worship: {
    ...
    translation: [
      {
        language: 'fa',
        translation: ['پرستش', 'عبادت', 'نیایش', 'عبادی', 'عبادات', 'نماز'],
      },
    ],
  },
  coinage: {
    ...
    translation: [
      {
        language: 'fa',
        translation: ['ضرب سکه', 'ضرب', 'سکه', 'مسکوکات', 'پول', 'ضرب پول'],
      },
    ],
  },
  transcend: {
